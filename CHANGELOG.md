...
## [0.4.13] - 2019-04-24
### Fixed
- 修复单行已存在prop后不能再触发prop提示的bug
- 修改部分组件提示问题

## [0.4.12] - 2019-03-19
### Fixed
- 组件引用补全迁移，限制在components对象内

## [0.4.11] - 2019-03-15
### Added
- 增加常用HTML5标签，不建议使用内置emmet语法
...
## [0.4.3] - 2019-02-15
### Fixed
- 修复存在methods但内部无方法声明时不触发this.补全

## [0.4.2] - 2019-01-25
### Fixed
- 修复组件自动添加对的引用前为tab而非空格

## [0.4.1] - 2019-01-24
### Added
- 覆盖全部组件, 新增30个Atom组件补全

## [0.4.0] - 2019-01-23
### Added
- 增加触发Atom组件补全后自动添加引用功能
